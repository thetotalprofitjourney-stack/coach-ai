...
- Las puntuaciones DISC son enteros entre 0 y 100. Calcúlalas a partir de los factores elegidos por el usuario en los 16 ítems (cuenta cuántas veces el factor fue elegido, normaliza sobre 16 y multiplica por 100, redondeando al entero más cercano). Si hay empates o un perfil equilibrado, las puntuaciones lo deben reflejar — no fuerces un dominante.
- `terminos_subjetivos` contiene entre 3 y 6 palabras o expresiones cortas cargadas de significado propio detectadas en el texto libre del usuario (disparador, matizaciones de ítems). Son términos existenciales o de estado sin especificación operacional ("propósito", "estar listo", "volver a ser yo"), que requerirán desambiguación en Fase 2. Úsalos en la forma exacta en que el usuario los empleó si es posible.
